...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return Game; });\n/* harmony import */ var _engine_webgl_Animation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./engine/webgl/Animation */ \"./src/engine/webgl/Animation.ts\");\n/* harmony import */ var _engine_webgl_Sprite__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./engine/webgl/Sprite */ \"./src/engine/webgl/Sprite.ts\");\n/* harmony import */ var _engine_GameWithLoop__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./engine/GameWithLoop */ \"./src/engine/GameWithLoop.ts\");\n/* harmony import */ var _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./engine/entity/StaticEntity */ \"./src/engine/entity/StaticEntity.ts\");\n/* harmony import */ var _engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./engine/input/InputSignal */ \"./src/engine/input/InputSignal.ts\");\n/* harmony import */ var _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./engine/entity/wall/Wall */ \"./src/engine/entity/wall/Wall.ts\");\n/* harmony import */ var _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./engine/entity/wall/WallType */ \"./src/engine/entity/wall/WallType.ts\");\n/* harmony import */ var _engine_entity_FireColumn__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./engine/entity/FireColumn */ \"./src/engine/entity/FireColumn.ts\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nclass Game extends _engine_GameWithLoop__WEBPACK_IMPORTED_MODULE_2__[\"default\"] {\r\n    constructor(render, inputManager) {\r\n        super(60);\r\n        this.render = render;\r\n        this.inputManager = inputManager;\r\n        this.entities = [];\r\n        this.sword = new _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__[\"default\"](-8 + 32, -8, 1, 0, new _engine_webgl_Sprite__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\"sword\"));\r\n        this.createFloors();\r\n        this.createWalls();\r\n        this.entities.push(new _engine_entity_FireColumn__WEBPACK_IMPORTED_MODULE_7__[\"default\"](-12 + -2 * 16, -10 + 3 * 16, 1, 0), new _engine_entity_FireColumn__WEBPACK_IMPORTED_MODULE_7__[\"default\"](-12 + -2 * 16, -2 + -2 * 16, 1, 0), new _engine_entity_FireColumn__WEBPACK_IMPORTED_MODULE_7__[\"default\"](-4 + 2 * 16, -10 + 3 * 16, 1, 0), new _engine_entity_FireColumn__WEBPACK_IMPORTED_MODULE_7__[\"default\"](-4 + 2 * 16, -2 + -2 * 16, 1, 0));\r\n        this.entities.push(new _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__[\"default\"](-8, -8, 1, 0, new _engine_webgl_Animation__WEBPACK_IMPORTED_MODULE_0__[\"default\"]([\r\n            \"bat_up\",\r\n            \"bat_down\",\r\n        ], 20)));\r\n        inputManager.addMapping(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].UP, \"w\");\r\n        inputManager.addMapping(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].RIGHT, \"d\");\r\n        inputManager.addMapping(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].DOWN, \"s\");\r\n        inputManager.addMapping(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].LEFT, \"a\");\r\n    }\r\n    tick(frame) {\r\n        const x = +this.inputManager.getStatus(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].LEFT) * -1 + +this.inputManager.getStatus(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].RIGHT);\r\n        const y = +this.inputManager.getStatus(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].UP) * -1 + +this.inputManager.getStatus(_engine_input_InputSignal__WEBPACK_IMPORTED_MODULE_4__[\"default\"].DOWN);\r\n        this.render.translate(x, y);\r\n        for (const sprite of this.entities) {\r\n            sprite.tick(frame);\r\n        }\r\n        this.sword.setRotation(this.sword.getRotation() + Math.PI / 120);\r\n    }\r\n    draw() {\r\n        this.render.clear();\r\n        for (const sprite of this.entities.sort((a, b) => Math.sign(a.getZ() - b.getZ()))) {\r\n            sprite.draw(this.render);\r\n        }\r\n        this.sword.draw(this.render);\r\n    }\r\n    createFloors() {\r\n        for (let x = -7; x <= -3; ++x) {\r\n            for (let y = -2; y <= 2; ++y) {\r\n                this.entities.push(new _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__[\"default\"](-8 + x * 16, -8 + y * 16, 0, 0, new _engine_webgl_Sprite__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\"floor\")));\r\n            }\r\n        }\r\n        for (let x = -2; x <= 2; ++x) {\r\n            for (let y = -7; y <= 7; ++y) {\r\n                this.entities.push(new _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__[\"default\"](-8 + x * 16, -8 + y * 16, 0, 0, new _engine_webgl_Sprite__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\"floor\")));\r\n            }\r\n        }\r\n        for (let x = 3; x <= 7; ++x) {\r\n            for (let y = -2; y <= 2; ++y) {\r\n                this.entities.push(new _engine_entity_StaticEntity__WEBPACK_IMPORTED_MODULE_3__[\"default\"](-8 + x * 16, -8 + y * 16, 0, 0, new _engine_webgl_Sprite__WEBPACK_IMPORTED_MODULE_1__[\"default\"](\"floor\")));\r\n            }\r\n        }\r\n    }\r\n    createWalls() {\r\n        for (let x = -7; x <= -4; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, 3 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].TOP));\r\n        }\r\n        for (let x = -2; x <= 2; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, 8 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].TOP));\r\n        }\r\n        for (let x = 4; x <= 7; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, 3 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].TOP));\r\n        }\r\n        for (let x = -7; x <= -4; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, -8 + -2 * 16, 2, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].BOTTOM));\r\n        }\r\n        for (let x = -2; x <= 2; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, -8 + -7 * 16, 2, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].BOTTOM));\r\n        }\r\n        for (let x = 4; x <= 7; ++x) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + x * 16, -8 + -2 * 16, 2, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].BOTTOM));\r\n        }\r\n        for (let y = 5; y <= 8; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].LEFT));\r\n        }\r\n        for (let y = -1; y <= 3; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -8 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].LEFT));\r\n        }\r\n        for (let y = -6; y <= -3; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].LEFT));\r\n        }\r\n        for (let y = 5; y <= 8; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].RIGHT));\r\n        }\r\n        for (let y = -1; y <= 3; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 8 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].RIGHT));\r\n        }\r\n        for (let y = -6; y <= -3; ++y) {\r\n            this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, -8 + y * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].RIGHT));\r\n        }\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -8 * 16, -8 + 4 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_TOP_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -8 * 16, -8 + -2 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_BOTTOM_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, -8 + 9 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_TOP_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, -8 + -7 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_BOTTOM_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 8 * 16, -8 + 4 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_TOP_RIGHT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 8 * 16, -8 + -2 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_BOTTOM_RIGHT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, -8 + 9 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_TOP_RIGHT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, -8 + -7 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONCAVE_CORNER_BOTTOM_RIGHT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, 3 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONVEX_CORNER_TOP_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, 3 * 16, -1, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONVEX_CORNER_TOP_RIGHT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + -3 * 16, -8 + -2 * 16, 2, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONVEX_CORNER_BOTTOM_LEFT));\r\n        this.entities.push(new _engine_entity_wall_Wall__WEBPACK_IMPORTED_MODULE_5__[\"default\"](-8 + 3 * 16, -8 + -2 * 16, 2, 0, _engine_entity_wall_WallType__WEBPACK_IMPORTED_MODULE_6__[\"default\"].CONVEX_CORNER_BOTTOM_RIGHT));\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/Game.ts?");
...
/***/ "./src/engine/webgl/TranslationManager.ts":
/*!************************************************!*\
  !*** ./src/engine/webgl/TranslationManager.ts ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _engine_webgl_Render__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./engine/webgl/Render */ \"./src/engine/webgl/Render.ts\");\n/* harmony import */ var _Game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Game */ \"./src/Game.ts\");\n/* harmony import */ var _engine_input_InputManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./engine/input/InputManager */ \"./src/engine/input/InputManager.ts\");\n/* harmony import */ var _data_textrues_textures_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./data/textrues/textures.png */ \"./src/data/textrues/textures.png\");\n/* harmony import */ var _data_textrues_textures_png__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_data_textrues_textures_png__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _engine_webgl_TextureManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./engine/webgl/TextureManager */ \"./src/engine/webgl/TextureManager.ts\");\n/* harmony import */ var _engine_webgl_SpriteShaderProgram__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./engine/webgl/SpriteShaderProgram */ \"./src/engine/webgl/SpriteShaderProgram.ts\");\n/* harmony import */ var _data_shaders_vertex_glsl__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data/shaders/vertex.glsl */ \"./src/data/shaders/vertex.glsl\");\n/* harmony import */ var _data_shaders_fragment_glsl__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./data/shaders/fragment.glsl */ \"./src/data/shaders/fragment.glsl\");\n/* harmony import */ var _data_textrues_descriptor_fireColumn_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./data/textrues/descriptor/fireColumn.json */ \"./src/data/textrues/descriptor/fireColumn.json\");\nvar _data_textrues_descriptor_fireColumn_json__WEBPACK_IMPORTED_MODULE_8___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./data/textrues/descriptor/fireColumn.json */ \"./src/data/textrues/descriptor/fireColumn.json\", 1);\n/* harmony import */ var _data_textrues_descriptor_knight_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./data/textrues/descriptor/knight.json */ \"./src/data/textrues/descriptor/knight.json\");\nvar _data_textrues_descriptor_knight_json__WEBPACK_IMPORTED_MODULE_9___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./data/textrues/descriptor/knight.json */ \"./src/data/textrues/descriptor/knight.json\", 1);\n/* harmony import */ var _data_textrues_descriptor_others_json__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./data/textrues/descriptor/others.json */ \"./src/data/textrues/descriptor/others.json\");\nvar _data_textrues_descriptor_others_json__WEBPACK_IMPORTED_MODULE_10___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./data/textrues/descriptor/others.json */ \"./src/data/textrues/descriptor/others.json\", 1);\n/* harmony import */ var _data_textrues_descriptor_wall_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./data/textrues/descriptor/wall.json */ \"./src/data/textrues/descriptor/wall.json\");\nvar _data_textrues_descriptor_wall_json__WEBPACK_IMPORTED_MODULE_11___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./data/textrues/descriptor/wall.json */ \"./src/data/textrues/descriptor/wall.json\", 1);\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nwindow.onload = function () {\r\n    let textures = new Image();\r\n    textures.onload = () => {\r\n        const render = new _engine_webgl_Render__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"canvas\", gl => new _engine_webgl_SpriteShaderProgram__WEBPACK_IMPORTED_MODULE_5__[\"default\"](gl, _data_shaders_vertex_glsl__WEBPACK_IMPORTED_MODULE_6__[\"default\"], _data_shaders_fragment_glsl__WEBPACK_IMPORTED_MODULE_7__[\"default\"]), gl => new _engine_webgl_TextureManager__WEBPACK_IMPORTED_MODULE_4__[\"default\"](gl, textures, [_data_textrues_descriptor_fireColumn_json__WEBPACK_IMPORTED_MODULE_8__, _data_textrues_descriptor_knight_json__WEBPACK_IMPORTED_MODULE_9__, _data_textrues_descriptor_others_json__WEBPACK_IMPORTED_MODULE_10__, _data_textrues_descriptor_wall_json__WEBPACK_IMPORTED_MODULE_11__]));\r\n        render.resize(window.innerWidth, window.innerHeight);\r\n        const inputManager = new _engine_input_InputManager__WEBPACK_IMPORTED_MODULE_2__[\"default\"]();\r\n        const game = new _Game__WEBPACK_IMPORTED_MODULE_1__[\"default\"](render, inputManager);\r\n        function run(timestamp) {\r\n            game.update(timestamp);\r\n            requestAnimationFrame(run);\r\n        }\r\n        window.onresize = () => {\r\n            render.resize(window.innerWidth, window.innerHeight);\r\n        };\r\n        window.onkeydown = (event) => {\r\n            inputManager.onKeyDown(event);\r\n        };\r\n        window.onkeyup = (event) => {\r\n            inputManager.onKeyUp(event);\r\n        };\r\n        requestAnimationFrame(run);\r\n    };\r\n    textures.src = _data_textrues_textures_png__WEBPACK_IMPORTED_MODULE_3___default.a;\r\n};\r\n\n\n//# sourceURL=webpack:///./src/index.ts?");
